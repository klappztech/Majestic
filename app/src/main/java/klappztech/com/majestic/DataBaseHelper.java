...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    private static String DB_PATH = "/data/data/klappztech.com.majestic/databases/";

    private static String DB_NAME = "db_majestic",DATABASE_TABLE = "routes_table" ;

    public SQLiteDatabase myDataBase;

    private final Context myContext;
    private String fieldObjectName = "bus_no";
    ...
    public boolean checkIfExists(String objectName){
        ...
        Cursor cursor = db.rawQuery("SELECT " + fieldObjectName + " FROM " + DATABASE_TABLE + " WHERE " + fieldObjectName + " = '" + objectName + "'", null);
